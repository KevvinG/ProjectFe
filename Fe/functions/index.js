...
const twilioSID = 'AC987cf9f37cc002f4dab270b6ded94aed';
const twilioAuth = '5e986bddcee10368f12957e491bdd57a';
const twilioPhone = '+18783136182';
...
exports.heartRateDataAnalysis = functions.https.onRequest(async (req, res) => {
    ...
    // Get emergency switch from request parameter
    const emergencySwitch = req.query.emergencySwitch;
    if (emergencySwitch == null || emergencySwitch == "") {
        console.log("emergencySwitch is empty. Considering switch as false.");
    }
    ...
    if (returnBody.length == 0) {
        ...
        // Evaluate if message should be sent to Emergency Contact
        if (emergencySwitch == "true") {
            client.messages
              .create({
                 body: `${fName} heart rate anomaly detected.`,
                 from: twilioPhone,
                 to: `+${emergencyPhone}`
               })
...
//MARK: Medication Reminder Function
